...
async function ownerAlert(resendKey, info) {
  ...
  var inner =
    '<div style="padding:32px 30px 14px;text-align:center">' +
      '<span style="display:inline-block;background:#fdecea;color:#b91c1c;font-size:11.5px;font-weight:800;letter-spacing:.08em;text-transform:uppercase;padding:7px 16px;border-radius:50px">Action needed</span>' +
      ...
      '<div style="background:#f7f9f3;border-radius:12px;padding:16px 18px;text-align:left;font-size:13.5px;color:#1A1A1A;line-height:1.9">' +
